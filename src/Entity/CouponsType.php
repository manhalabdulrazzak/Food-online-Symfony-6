...
class CouponsType
{
    ...
    #[ORM\OneToMany(mappedBy: 'coupns_types', targetEntity: Coupons::class, orphanRemoval: true)]
    private $coupons;
    ...
    public function removeCoupon(Coupons $coupon): self
    {
        if ($this->coupons->removeElement($coupon)) {
            ...
            if ($coupon->getCoupnsTypes() === $this) {
                $coupon->setCoupnsTypes(null);
            }
        }
